...
module alpha_lending::alpha_lending {
    ...
    public struct MarketCapHolder has key, store {
        id: UID,
        market_holder_cap_id: ID
    }

    public struct MarketCapHolderCap has key, store {
        id: UID
    }
    ...
    public struct LPPositionLiquidationEvent has copy, drop {
        repay_type: TypeName,
        position_id: ID,
        repay_amount: u64,
        repay_value: u64,
